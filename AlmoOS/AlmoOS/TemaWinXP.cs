...
namespace AlmoOS
{
    public partial class TemaWinXP : Form
    {
        ...
        private void picBoxGoogleMenu_Click_1(object sender, EventArgs e)
        {
            abrirGoogle();
        }

        private void labGoogle_Click_1(object sender, EventArgs e)
        {
            abrirGoogle();
        }

        private void picBoxApagar_Click_1(object sender, EventArgs e)
        {
            Application.Exit();
        }
